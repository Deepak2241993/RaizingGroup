               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item"><a href="{{ route('employee.create') }}" class="nav-link"><i
                                    class="far fa-circle nav-icon"></i>
                                <p>Add Employee</p>
                            </a></li>
                        <li class="nav-item"><a href="{{ route('employee.index') }}" class="nav-link"><i
                                    class="far fa-circle nav-icon"></i>
                                <p>Employee List</p>
                            </a></li>
                        <li class="nav-item"><a href="{{ route('employeetask.index') }}" class="nav-link"><i
                                    class="far fa-circle nav-icon"></i>
                                <p>All Employee Task</p>
                            </a></li>
                        <li class="nav-item"><a href="{{ route('admintask.index') }}" class="nav-link"><i
                                    class="far fa-circle nav-icon"></i>
                                <p>All Admin Task</p>
                            </a></li>
                        <li class="nav-item"><a href="{{ route('managementtask.index') }}" class="nav-link"><i
                                    class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item"><a href="{{ route('customer-query.create') }}" class="nav-link"><i
                                    class="far fa-circle nav-icon"></i>
                                <p>Add Query</p>
                            </a></li>
                        <li class="nav-item"><a href="{{ route('customer-query.index') }}" class="nav-link"><i
                                    class="far fa-circle nav-icon"></i>
                                <p>All Query</p>
                            </a></li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item"><a href="{{ route('holiday.create') }}" class="nav-link"><i
                                    class="far fa-circle nav-icon"></i>
                                <p>Add Holiday</p>
                            </a></li>
                        <li class="nav-item"><a href="{{ route('holiday.index') }}" class="nav-link"><i
                                    class="far fa-circle nav-icon"></i>
                                <p>All Holiday</p>
                            </a></li>
